					...
					<div class="col-md-3 col-sm-6 col-xs-6">
						<div class="panel panel-back noti-box">
							...
							<div class="text-box">
								...
								<p class="text-muted">Tin nhắn mới</p>
							</div>
						</div>
					</div>
					<div class="col-md-3 col-sm-6 col-xs-6">
					...
					<div class="col-md-3 col-sm-6 col-xs-6">
						<div class="panel panel-back noti-box">
							...
							<div class="text-box">
								...
								<p class="text-muted">Đơn hàng cần xử lí</p>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-md-3 col-sm-12 col-xs-12">
					<div
						...
						<div class="panel-body">
							...
							<h4>200 phản hồi</h4>
							<h4>Xem các phản hồi</h4>
						</div>
						<div class="panel-footer back-footer-green">
							<i class="fa fa-rocket fa-5x"></i> Các phản hồi mới của khách hàng về sản phẩm được thống kê bởi bảng bên
