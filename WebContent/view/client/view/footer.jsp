		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4 md-margin-bottom-40">
					...
					<p>Sách Tốt - luôn mang đến những sản phẩm chất lượng nhất cho bạn.</p>
					<br>
					<ul class="list-unstyled address-list margin-bottom-20">
						<li><i class="fa fa-angle-right"></i>Hà Nội - Việt Nam</sli>
						<li><i class="fa fa-angle-right"></i>Phone: 0973.983.546</li>
						<li><i class="fa fa-angle-right"></i>Hotline: 01299 725 789</li>
						<li><i class="fa fa-angle-right"></i>Email: sachtot@gmail.com</li>
					</ul>
	...
	<div class="copyright">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<p>
						2019 &copy; Development by Nhom11 <a target="_blank"
							href="https://www.facebook.com/sachtot">Htmlstream</a> | <a
