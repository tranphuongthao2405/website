										...
										<div class="panel-group" id="accordion">
												...
												<div id="collapseOne" class="panel-collapse collapse in">
													<div class="panel-body cus-form-horizontal">
														<div class="form-group">
															<label class="col-sm-4 no-col-space control-label">Tên trên thẻ</label>
															<div class="col-sm-8">
														...
														<div class="form-group">
															<label class="col-sm-4 no-col-space control-label">Mã thẻ</label>
															<div class="col-sm-8">
																<input type="text" class="form-control required"
											...
											<div class="panel panel-default">
												<div class="panel-heading">
													<h4 class="panel-title">
														<a data-toggle="collapse" data-parent="#accordion"
															href="#collapseTwo"> <i class="fa fa-paypal"></i>Trả bằng Paypal</a>
													</h4>
												</div>
							...
							<div class="row">
								<div class="col-sm-4 sm-margin-bottom-30">
									...
									<input class="form-control margin-bottom-10" name="code"
										type="text">
									<button type="button" class="btn-u btn-u-sea-shop">Dùng mã</button>
								</div>
								<div class="col-sm-3 col-sm-offset-5">
									<ul class="list-inline total-result">
										<li>
											<h4>Tổng tiền hàng:</h4> <c:set var="total" value="${0}" /> <c:forEach
