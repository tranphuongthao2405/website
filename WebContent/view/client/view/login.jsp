			...
			<div class="container">
				<div class="row">
					<div class="col-md-7 md-margin-bottom-50">
						...
						<div class="info-block-v2">
							...
							<div class="info-block-in">
								...
								<p>Sách của chúng tôi được nhập từ những nhà xuất bản có uy tín.</p>
							</div>
						</div>
						<div class="info-block-v2">
							...
							<div class="info-block-in">
								<h3>Giá cả hợp lí</h3>
								<p>Sách Tốt cam kết sách chính hãng, giá cả hợp lí, bảo đảm quyền lợi cho khách hàng.</p>
							</div>
						</div>
						<div class="info-block-v2">
							<i class="icon icon-paper-plane"></i>
							<div class="info-block-in">
								<h3>Khuyến mại siêu khủng</h3>
								<p>Sách Tốt luôn có những đợt Sale khủng vào những dịp lễ đặc biệt. Hãy đăng kí tài khoản để nhận được thông báo mới nhất từ chúng tôi.</p>
							</div>
						</div>
					</div>
					...
					<div class="col-md-5">
						...
						<p class="text-center">
							Nếu bạn chưa có tài khoản, hãy <a
