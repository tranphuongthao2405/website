	...
	<div class="wrapper">
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<ul class="list-inline product-ratings margin-bottom-30">
							...
							<li><i class="rating fa fa-star"></i></li>
							<li class="product-review-list"><span>(1) <a href="#">Đánh giá</a>
									| <a href="#"> Thêm đánh giá</a></span></li>
						</ul>
			...
			<div class="tab-v5">
				...
				<div class="tab-content">
					...
					<div class="tab-pane fade in active" id="description">
						<div class="row">
							<div class="col-md-12">
								<p>Việc lựa chọn tất nhiên đòi hỏi nhiều sáng suốt, nhưng trên hết người lựa chọn phải hiểu rõ thế giới mà mình đang sống 
								và biết rõ chính mình muốn gì, và một mặt khác phải sẵn sàng cáng đáng lấy trách nhiệm trong sự lựa chọn. Nói một cách 
								hoa mỹ hơn, mình chỉ tìm ra hướng đi đúng đắn và phù hợp cho bản thân nếu thấu hiểu rõ bản năng, bản ngã và cả tiềm thức 
								của chính mình. Cùng một tinh thần luôn sẵn sàng đối mặt với những hệ quả tốt và xấu từ sự lựa chọn ấy.</p>
						...
						<div class="product-comment margin-bottom-40">
							<div class="product-comment-in">
								...
								<div class="product-comment-dtl">
									<h4>
										Mickel <small>22 ngày trước</small>
									</h4>
									<p>I like the green colour, it's very likeable and reminds
										me of Hollister. The content is great.</p>
		...
		<div class="container">
			<div class="heading heading-v1 margin-bottom-20">
				...
				<p>Tri thức là sức mạnh. Sách khoa học thường thức mang đến cho chúng ta hiểu biết phong phú, thế giới quan đa dạng. Hãy tìm đọc ngay hôm nay.</p>
			</div>
